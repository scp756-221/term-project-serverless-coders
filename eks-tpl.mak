...
# TODO: modify the variables based on the project
NS=c756ns
CLUSTER_NAME=aws756
EKS_CTX=aws756
...
# Create a nodegroup for an EKS cluster whose group was previously deleted
up:
...
#Delete your EKS cluster’s nodegroup
down:
